      ...
      >
          ...
          >
              ...
              <div className="flex min-w-0 max-w-full items-center justify-between gap-2 mb-2.5">
                ...
                <div className="relative group/refresh shrink-0">
                  <Button
                    ...
                    aria-label={t('discoveryView.refresh')}
            ...
            <div className="flex items-center gap-1.5">
              ...
              <Select value={trendingTimeRange} onValueChange={(value) => setTrendingTimeRange(value as TrendingTimeRange)}>
                <SelectTrigger aria-label={t('discoveryView.time-range')} className="ui-field h-11 w-auto max-w-full min-w-28 px-3 text-base font-medium text-foreground dark:text-foreground sm:h-9 sm:text-sm"><SelectValue /></SelectTrigger>
                <SelectContent>
        ...
        {selectedDiscoveryChannel === 'topic' && (
                  <Select value={discoverySelectedTopic || 'all'} onValueChange={(value) => setDiscoverySelectedTopic(value === 'all' ? null : value as TopicCategory)}>
                    <SelectTrigger aria-label={t('discoveryView.topic-filter')} className="ui-field h-11 w-auto max-w-full min-w-28 px-3 text-base font-medium text-foreground dark:text-foreground sm:h-9 sm:text-sm"><SelectValue placeholder={t('discoveryView.topic')} /></SelectTrigger>
                    <SelectContent>
              ...
              <div className={isDesktopSafeMode
                ...
                <div className="flex flex-wrap gap-2.5">
                  <Select value={discoveryLanguage} onValueChange={(value) => setDiscoveryLanguage(value as ProgrammingLanguage)}>
                    <SelectTrigger aria-label={t('discoveryView.programming-language')} className="ui-field h-11 w-auto max-w-full min-w-32 px-3 text-base font-medium text-foreground dark:text-foreground sm:h-9 sm:text-sm"><SelectValue /></SelectTrigger>
                    <SelectContent>
