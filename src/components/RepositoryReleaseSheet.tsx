...
const ReleaseAssetsTable: React.FC<{
  ...
  return (
    <>
      <Table className="min-w-[28rem] table-fixed" aria-label={t('repositoryReleaseSheet.v1-assets', { v1: release.tag_name })}>
        <TableHeader>
          <TableRow>
  ...
  return (
    <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
      <TabsList className="grid h-11 w-full grid-cols-3 sm:h-8">
        <TabsTrigger className="h-11 text-xs sm:h-8" value="assets">{t('repositoryReleaseSheet.assets')}</TabsTrigger>
        <TabsTrigger className="h-11 text-xs sm:h-8" value="notes">{t('repositoryReleaseSheet.notes')}</TabsTrigger>
        <TabsTrigger className="h-11 text-xs sm:h-8" value="summary">{t('repositoryReleaseSheet.summary')}</TabsTrigger>
      </TabsList>
