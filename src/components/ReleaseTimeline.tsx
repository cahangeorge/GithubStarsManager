      ...
      <div className="mb-6 sm:mb-8">
        ...
        <div className="flex min-w-0 flex-col gap-2 mb-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex w-full min-w-0 flex-wrap items-center justify-start gap-3 lg:w-auto lg:justify-end">
            ...
            <div className="flex max-w-full shrink-0 items-center gap-2 whitespace-nowrap">
              ...
              <Select value={String(itemsPerPage)} onValueChange={(value) => { setItemsPerPage(Number(value)); setCurrentPage(1); }}>
                <SelectTrigger aria-label={t('releaseTimeline.items-per-page')} className="ui-field h-11 w-20 shrink-0 px-3 py-1 text-base sm:h-9 sm:text-sm"><SelectValue /></SelectTrigger>
